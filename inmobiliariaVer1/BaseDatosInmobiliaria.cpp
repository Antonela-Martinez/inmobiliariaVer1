...
DataTable^ BaseDatosInmobiliaria::getDataInmueble() {
...
void BaseDatosInmobiliaria::insertarIn(String^ nC, String^ cl, String^ tp, String^ ca, String^ n, String^ p, String^ cpr, String^ am, String^ co, String^ dor, String^ ba, String^ spc, String^ spt, String^ adc) {

	String^ sql = "insert into inmueble(nombreC, clase, tipo, calle, numero, provincia, cp, ambientes, cocheras, dormitorios, baños, spcubierta, sptotal, adicional) values ('" + nC + "','" + cl + "', '" + tp + "', '" + ca + "', " + n + ", '" + p +"', '" + cpr + "', " + am + ", " + co + ", " + dor + ", " + ba + ", " + spc + ", " + spt + ", '" + adc + "')";
	MySqlCommand^ cursor = gcnew MySqlCommand(sql, getConnection());
...
void BaseDatosInmobiliaria::modificarIn(String^ nC, String^ cl, String^ tp, String^ ca, String^ n, String^ p, String^ cpr, String^ am, String^ co, String^ dor, String^ ba, String^ spc, String^ spt, String^ adc, String^ nomre) {

	String^ sql = "update inmueble set nombreC = '" + nC + "', clase = '" + cl + "', tipo = '" + tp + "',  calle = '" + ca + "', numero = '" + n + "', provincia = '" + p + "' , cp = '" + cpr + "' , ambientes = '" + am + "' , cocheras = '" + co + "' , dormitorios = '" + dor + "' , baños = '" + ba + "' , spcubierta = '" + spc + "' , sptotal = '" + spt + "' , adicional = '" + adc + "' where nombreC = '" + nomre + "'";
	MySqlCommand^ cursor = gcnew MySqlCommand(sql, getConnection());
...
void BaseDatosInmobiliaria::eliminarIn(String^ nombre) {
	String^ sql = "delete from inmueble where nombreC = '" + nombre + "'";
	MySqlCommand^ cursor = gcnew MySqlCommand(sql, getConnection());
